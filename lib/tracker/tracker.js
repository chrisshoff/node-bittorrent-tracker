...
Peer.prototype = {
	...
	timedOut: function(n) {
		...
		return n - this.lastAction > ANNOUNCE_INTERVAL * 2 * 1000;
	},
...
Tracker.prototype = {
	...
	getStatus: function(response, display) {
		var status = {};
		var idx = 0;
		for (var i in this.files) {
			...
			status[idx] = {};
			status[idx].peers = {};
			status[idx].torrent = idx + " | downloaders: " + torrent.downloads + " | seeders: " + torrent.seeders + " | leechers: " + torrent.leechers;
